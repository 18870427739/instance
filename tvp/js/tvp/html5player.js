...
!function (a, b) {
    a.html5lang = {
        ...
        definition: {mp4: "\u9ad8\u6e05", msd: "\u6d41\u7545"},
        srtLang: {
            50001: {srclang: "zh-cn", desc: "\u7b80\u4f53\u4e2d\u6587"},
            50002: {srclang: "zh-cn", desc: "\u7b80\u4f53\u4e2d\u6587"},
            50003: {srclang: "zh-tw", desc: "\u7e41\u4f53\u4e2d\u6587"},
            50004: {srclang: "en", desc: "\u82f1\u6587"},
            50005: {srclang: "zh-cn,en", desc: "\u7b80\u4f53\u4e2d\u6587&\u82f1\u6587"},
            50006: {srclang: "zh-tw,en", desc: "\u7e41\u4f53\u4e2d\u6587&\u82f1\u6587"}
        },
        durationLimit: {
    ...
    a.BaseHtml5 || (a.BaseHtml5 = function () {
        ...
        getPlayer: function () {
            ...
            d && (d.width(b.formatSize(a)).height(b.formatSize(c)), d && d.trigger && d.trigger("tvp:resize"))
        }, showError: function (c, d, e) {
            var f = this;
            setTimeout(function () {
                if (!f.videoTag || !f.videoTag.src || f.videoTag.paused) {
                    b(f.videoTag).removeAttr("src"), f.videoTag.load();
                    ...
                    if (b.isFunction(g) && g != f.showError) g.call(f, c, d, e); else if (b.isFunction(f.config.showError)) f.config.showError.call(f, c, d, e); else {
                        ...
                        var l = b(f.$UILayer), m = b(b.trim(h)).appendTo(l).show();
                        l && 0 !== l.length || (l = b(f.videomod), l.html('<div class="tvp_container tvp_controls_hide"></div>'), l = l.find(".tvp_container")), m.appendTo(l), e.indexOf("\u5237\u65b0") > -1 && l.find('[data-role="error-refresh"]').removeClass("tvp_none").on("click touchend", function () {
        ...
        this.videoTag = null, this.$video = null, this.config.width = a.$.filterXSS(c), this.config.height = a.$.filterXSS(d), this.protectedFn = {}, this.isUseControl = !0, b.extend(this.h5EvtAdapter, {
            onEnded: function () {
                if (!this.isPlayingLoadingAd() && !this.isPlayingSplit) {
                    this.$video && this.$video.trigger && this.$video.trigger("tvp:player:ended"), this.callCBEvent("onended", f);
                    var c = "", d = this.curVideo.getVidList().split("|"), e = b.inArray(f, d);
                ...
                }), d.target.currentSrc.indexOf(".m3u8") > 0 && (a.debug("play hls error,reload play mp4..."), e.dataset.hlsIndex || (e.dataset.hlsIndex = 1), e.dataset.hlsIndex++, e.curVideo.dataHls && "array" === b.type(e.curVideo.dataHls) && e.curVideo.dataHls.length > 1 && e.curVideo.dataHls[e.dataset.hlsIndex] && 0 === e.curVideo.dataHls[e.dataset.hlsIndex].indexOf("http") && e.$video && (e.$video.attr("src", e.curVideo.dataHls[e.dataset.hlsIndex]), e.$video[0] && e.$video[0].load))) return e.$video[0].load(), void e.$video[0].play();
                var f = -1;
                d.target && d.target.error && (f = d.target.error.code), 4 == f && this.showError(0, f)
            }, onPlaying: function () {
                var a = this;
                this.callCBEvent("onplaying", f, this.curVideo), this.isShowingDurationLimit() && this.pause(), setTimeout(function () {
                    a.isPlayingLoadingAd() || a.isPlayingSplit || a.goOnPlaying()
                }, 50)
            }, onTimeupdate: function () {
                this.callCBEvent("ontimeupdate", f, this.$video), b.isFunction(this.setGoOnPlayingTime) && this.setGoOnPlayingTime()
            }, onPause: function () {
                b.os.android && this.config.isHtml5UseUI && this.$video.addClass("tvp_video_with_skin"), this.callCBEvent("onpause", f, this.$video), a.bossReport.user_action_report({
                    actions: "pause",
                    vid: f
                })
            }
        ...
        e.fn = e.prototype = new a.BaseHtml5, b.extend(e.prototype, {
            registerPlugins: function () {
                ...
                if (!this.has_report_playtime && !this.isPlayingSplit) {
                    ...
                    var a, c, d, e, f = 0, g = this, h = "tvp_report_h5_playtime", i = b.getData(h), j = this.$video[0],
                        k = this.curVideo.getVid(), l = function () {
                    ...
                    var m = function () {
                        n(), e = setInterval(function () {
                            f += 5, g.realPlayTime = f;
                            var a = k + "|" + f, c = parseInt(j.currentTime);
                            c && (a += "|" + c), b.setData(h, a)
                        }, 5e3)
                    }, n = function () {
                        e && clearInterval(e), e = null
                    }, o = function (a, c, d) {
                        g.report_playtime({vid: a, ptime: c, currentTime: d}), b.setData(h, 0)
                    };
                    i && i.indexOf("|") > -1 && (i = i.split("|"), a = i[0], c = i[1], d = i[2], o(a, c, d))
                }
            }, report_playtime: function (c) {
                var d = "", e = "";
                try {
                    d = top.location.href, e = top.location.hostname
                } catch (f) {
                }
                var g = {
                    ptime: c.ptime,
                ...
                }, h = new Image, i = "//btrace.video.qq.com/kvcollect?BossId=2803&Pwd=524422958&_dc=" + Math.random();
                i += "&" + b.param(g), h.src = i
            }
            ...
            pause: function () {
                ...
                function g(e) {
                    e = !!e, i.$video && i.$video.trigger && i.$video.trigger("tvp:video:ajaxstart", c instanceof a.VideoInfo ? c.getVid() : c, e);
                    ...
                    i.curVideo && l && (i.curVideo.defer_cache || (i.curVideo.defer_cache = {
                        ...
                        a && b.isFunction(a.done) && (i.curVideo.defer_cache.vd[l] = a, i.curVideo.callGetMp4UrlDefer = null)
                    }), i.curVideo.defer_cache.vd[l] || (i.curVideo.defer_cache.vd[l] = k.call(i.curVideo, c, i.isPlayingSplit)), i.curVideo.defer_cache.ad[l] || (i.curVideo.defer_cache.ad[l] = b.Deferred()), !a.Html5UI || !b.isFunction(a.Html5UI.fn.buildloadingAd) || !i.config.isHtml5UseUI || !i.config.isHtml5ShowLoadingAdOnStart && !i.config.isHtml5ShowLoadingAdOnChange || i.curVideo && b.isFunction(i.curVideo.getRequestAd) && i.curVideo.getRequestAd() === !1 ? i.curVideo.defer_cache.ad[l].resolve() : (i.$video.attr("tvp_loadingad_ended", 1), i.$video.off("tvp:loadingad:ended").on("tvp:loadingad:ended", function (a, c) {
                        c && !c.emptyAd && i.callCBEvent("onadend");
                        var d = c.vid || "";
                        if (d) {
                            if (!i.curVideo.defer_cache.vd[d]) return void (h && i.videoTag.src !== h ? (i.videoTag.src = h, !i.config.autoplayAfterLoadingad || c.emptyAd && !i.hasVideoChange || (i.videoTag.load(), i.$video.trigger("overlay_ctrl_showloading"), i.videoTag.play())) : (i.curVideo.defer_cache.ad[d] = b.Deferred(), i.curVideo.defer_cache.ad[d].resolve()));
                            h && j(h, i.config.autoplayAfterLoadingad && !c.emptyAd), i.curVideo.defer_cache.ad[d] || (i.curVideo.defer_cache.ad[d] = b.Deferred()), i.curVideo.defer_cache.ad[d].resolve()
                        }
                        ...
                        if (h = b, i.$video && i.$video.trigger && i.$video.trigger("tvp:video:ajaxsuc", b), i.config.isShowDurationLimit) try {
                            a.html5DurationLimit.create(i)
                        } catch (c) {
                        }
                        i._isInited || (i._isInited = !0, i.callCBEvent("oninited"));
                        var d = i.getCurVideo();
                        ...
                        i.$UILayer && "function" === b.type(i.$UILayer.find) && i.$UILayer.find(".tvp_player_error").remove(), i.curVideo.defer_cache.vd[l] = null, i.curVideo.defer_cache.ad[l] = null, c = "undefined" == typeof c ? !1 : c, b.os.android && b.browser.wechat && (a += "&nocache=1&time=" + (new Date).getTime()), i.isGetingInfo = !1, !b.browser.WeChat && "setAttribute" in i.videoTag ? i.videoTag.setAttribute("src", a) : i.videoTag.src = a, i.$video && i.$video.trigger && i.$video.trigger("tvp:video:src"), i._isInited || (i._isInited = !0, i.callCBEvent("oninited")), i.callCBEvent("onplay", i.curVideo.lastQueryVid, i.curVideo), (d || c) && (i.videoTag.load(), i.$video.trigger("overlay_ctrl_showloading"), i.videoTag.play());
                        ...
                        a = a || h, i.$UILayer && i.$UILayer.find(".tvp_player_error").remove(), j(a)
                    }).fail(function (b, c) {
                        return e ? (a.debug("get hls url fail,reload mp4..."), void g(!1)) : (i._isInited || (i._isInited = !0, i.callCBEvent("oninited")), i.$video && i.$video.trigger && i.$video.trigger("tvp:video:ajaxerror"), i.$video && i.$video.trigger && i.$video.trigger("tvp:video:error", b, c), i.videoTag.pause(), i.showError(b, c), void (i.isGetingInfo = !1))
                    }).always(function () {
                ...
                var h, i = this, j = !1;
                if (a.Html5Player && !(i instanceof a.Html5Player) && i.instance && i.instance instanceof a.Html5Player && (i = i.instance), b.isUndefined(d) && (d = !0), b.isUndefined(e) && (e = this.config.isHtml5UseHLS), !c && i.videoTag.src) return i.videoTag.currentTime || i.videoTag.load(), void i.videoTag.play();
                if (c instanceof a.VideoInfo) {
                    if (j = i.curVideo._vidBeforeChange ? i.curVideo._vidBeforeChange === c.getVid() ? !1 : !0 : !1, i.isPlayingSplit && i._isInited && i.getCurVid() === c.getVid()) return;
                    if (i.dataset && (i.dataset.isVidChange = j), i.setCurVideo(c), i.curVideo._vidBeforeChange = c.getVid(), j && (i.callCBEvent("onchange", i.curVideo.getFullVid()), this.$video && this.$video.trigger && this.$video.trigger("tvp:player:videochange"), i.$UILayer && i.$UILayer.find && i.$UILayer.find(".tvp_player_error").remove(), i.hasVideoChange = !0, h = null, i && i.videoTag && !i.videoTag.paused && i.videoTag.pause(), b.os.iphone)) try {
                        i.videoTag.pause(), i.videoTag.play()
                    } catch (k) {
                    }
                    c.setPid(b.createGUID()), f = i.curVideo.getFullVid()
                }
                ...
                var l = !1;
                "auto" === e ? a.common.isUseHLS() ? a.h5Helper.loadIsUseHLS({vid: f}).done(function (a) {
                    l = 3 == a
                }).fail(function () {
                    l = !1
                }).always(function () {
                    g.call(i, l)
                }) : (l = !1, g.call(i, l)) : (l = e, g.call(i, l))
                ...
                }), i = h, h = null, e = function () {
                    h = [];
                    for (var a in i) h.push(a + "|" + i[a]);
                    b.setData(f, JSON.stringify(h))
                }, "get" === a ? i[c] : void ("del" === a ? (i[c] = null, delete i[c], e()) : "set" === a && (i[c] = d, e()))
            }, setGoOnPlayingTime: function () {
                if (!this.isPlayingSplit && this.config.isContinuePlay) {
                    var a = this.getCurTime(), b = this.getDuration(), c = this.curVideo.getVid();
                    if (a = parseInt(a, 10), b = parseInt(b, 10), !(5 > a || this.isPlayingLoadingAd() || this._currentTime && this._currentTime === a)) return this._currentTime = a, 5 > b - a ? void this.goOnPlayingHandler("del", c) : void (0 !== a && a % 3 === 0 && this.goOnPlayingHandler("set", c, a))
                }
            }, goOnPlaying: function () {
                if (!this.isPlayingSplit && this.config.isContinuePlay && !(this.getCurTime() > 3 || this.hasShowGoOnPlaying)) {
                    var a = this.getCurVid(), a = this.curVideo.getVid(), b = this,
                        c = this.goOnPlayingHandler("get", a), d = this.$mod.find('[data-role="xubo-banner"]'),
                        e = this.$mod.find('[data-role="xubo-text"]'), f = e.html(), g = {};
                    if (c) {
                        c = parseInt(c), this.seek(c);
                        var h = function () {
                            f && (b.hasShowGoOnPlaying = !0, g.min = parseInt(c / 60), g.sec = parseInt(c % 60), f = 0 != g.min ? f.replace("{$min}", g.min + "\u5206") : f.replace("{$min}", ""), f = 0 != g.sec ? f.replace("{$sec}", g.sec + "\u79d2") : f.replace("{$sec}", ""), e.html(f), d.removeClass("tvp_none"), setTimeout(function () {
                                d.addClass("tvp_none")
                            }, 3e3))
                        };
                        h()
                ...
                var b = this;
                return b instanceof a.Html5Player || (b = b.instance), b.realPlayTime || 0
                ...
                g = setInterval(function () {
                    b.videoTag.paused || (a.push(b.videoTag.currentTime), a.length >= 2 && (0 == Math.abs(a[0] - a[1]) ? (g && clearInterval(g), a = [], b.videoTag.load(), b.videoTag.play()) : g && clearInterval(g), a = []))
                }, 500)
                ...
                return this.DurationLimitInstance = this.DurationLimitInstance || this.instance && this.instance.DurationLimitInstance, this.config.isShowDurationLimit && this.DurationLimitInstance && this.DurationLimitInstance.enable
            }
        }), a.Html5Tiny = e
    }
}(tvp, tvp.$), function (a, b) {
    ...
    var d = {
        case1: {
            promotionId: 755, downloadUrl: "http://mcgi.v.qq.com/commdatav2?cmd=4&confid=755&platform=aphone", texts: {
        ...
        initEvent1: function () {
            ...
            this.$video.off("play.limit").on("play.limit", function () {
                a.$limitPlay.addClass(f.HIDE), a.$limitRePlay.addClass(f.HIDE), a.downloaded || a.$banner.addClass(f.HIDE)
            }), this.$video.off("playing.limit").on("playing.limit", function () {
                a.$limitPlay.addClass(f.HIDE), a.$limitRePlay.addClass(f.HIDE), a.showDownload && (a.updateCountDownTime(), a.$smallBtnBox.removeClass(f.HIDE)), a.downloaded || a.$banner.addClass(f.HIDE), setTimeout(function () {
                    a.player && a.player.isPlayingLoadingAd && a.player.isPlayingLoadingAd() && a.$smallBtnBox.addClass(f.HIDE)
                }, 100), a.player.hasReportLimitShow || (a.player.hasReportLimitShow = !0, a.conf.hasApp && a.stepReport(6, 3))
            }), this.$video.off("pause.limit").on("pause.limit", function () {
                a.player.isTouching || this.ended || a.duration < this.currentTime || (a.player.isTouching || a.$limitPlay.removeClass(f.HIDE), a.showDownload && a.showBanner && a.$banner.removeClass(f.HIDE), a.$smallBtnBox.addClass(f.HIDE), setTimeout(function () {
                    a.hideControl()
                }, 500))
            }), this.$video.off("ended.limit").on("ended.limit", function () {
                a.player && a.player.isPlayingLoadingAd && a.player.isPlayingLoadingAd() || (a.$limitRePlay.removeClass(f.HIDE), a.$limitPlay.addClass(f.HIDE), a.downloaded || a.$banner.addClass(f.HIDE), a.$smallBtnBox.addClass(f.HIDE))
            }), this.$video.off("timeupdate.limit").on("timeupdate.limit", function () {
                a.showDownload && (a.remain = parseInt(a.duration - this.currentTime), a.updateCountDownTime())
            })
        }, initEvent2: function () {
            var a = this;
            this.$video.on("play", function () {
                ...
                a.showDownload && (a.updateCountDownTime(), a.$smallBtnBox.removeClass(f.HIDE)), setTimeout(function () {
                    a.player && a.player.isPlayingLoadingAd && a.player.isPlayingLoadingAd() && a.$smallBtnBox.addClass(f.HIDE)
                }, 100)
            }), this.$video.on("pause", function () {
                a.player.isTouching || this.ended || a.duration < this.currentTime || (a.$panel.removeClass(f.HIDE), a.$limitPlay.removeClass(f.HIDE), a.$limitRePlay.addClass(f.HIDE), a.$smallBtnBox.addClass(f.HIDE))
            }), this.$video.on("ended", function () {
                a.player && a.player.isPlayingLoadingAd && a.player.isPlayingLoadingAd() || (a.$limitRePlay.removeClass(f.HIDE), a.$limitPlay.addClass(f.HIDE), a.$panel.removeClass(f.HIDE), a.$smallBtnBox.addClass(f.HIDE))
            }), this.$video.on("timeupdate", function () {
                a.showDownload && (a.remain = parseInt(a.duration - this.currentTime), a.updateCountDownTime())
            })
        }, initEvent3: function () {
            var a = this, b = this.$video.get(0);
            b && this.$video.off("timeupdate.limit").on("timeupdate.limit", function () {
                var b = parseInt(this.currentTime, 10);
                b && a.showDownload && a.showSmallBtnOnTime(b) && (a.$panel.removeClass(f.HIDE), a.delayHideDOM())
            })
        }, playBtnEvent: function () {
            var a = this, b = this.$video.get(0);
            b && (a.$video.trigger("tvp_durationlimit_show"), a.$limitPlay.on("click", function () {
                a.player.play(null, !0)
            }), a.$limitRePlay.find(".tvp_overlay_replay").on("click", function () {
                b.currentTime = 0, b.load(), b.play()
            }))
        }
    }, h = {
        update: function (a) {
            var b, c, d = this;
            "afterInstall" === a || "hasapp" === a ? (d.downloaded = !1, b = d.conf.openUrl, c = "open") : (d.downloaded = !0, b = d.conf.downloadUrl, c = a), 1 === d.type && (d.$bannerBtn.attr({
                "data-status": c,
                "data-downloadurl": b
            }), d.$bannerTXT.attr({"data-text": d.renderData[a]})), "hasapp" !== a && "afterInstall" !== a ? d.$smallBtn.attr({
                "data-status": c,
                "data-downloadurl": b
            }) : d.$smallBtn.attr({
                "data-status": c,
                href: b
            }), d.$smallBtnTXT.attr({"data-text": d.renderData["_" + a]})
            ...
            a.conf.hasApp ? a.$btn.off("touchend.stepreport").on("touchend.stepreport", function () {
                a.stepReport(7, 3)
            }) : b.os.android || (b.os.ios || 2 === a.type) && (a.stepReport(1, 1), a.$btn.off("touchend.stepreport").on("touchend.stepreport", function () {
                a.stepReport(2, 1)
            }))
        }, setDownload1: function () {
            var c = this;
            this.$box = b([this.$banner.get(0), this.$smallBtnBox.get(0)]), this.$btn = b([this.$bannerBtn.get(0), this.$smallBtn.get(0)]), this.$btn.attr({
                href: c.conf.url,
                "data-downloadurl": c.conf.downloadUrl,
                "data-downloadmd5": c.conf.md5,
                "data-promotionid": c.conf.promotionId,
                "data-url": c.conf.openUrl
            }), b.os.android && (a.$.browser.WeChat || a.$.browser.MQQClient) && this.$btn.removeAttr("href"), this.bindDownloader(this.$box, this.$btn), h.onStatusChange.call(this), this.conf && this.conf.hasApp && a.common.bindNewMethodOnOpenAppInWeixin(this.$btn)
        }, setDownload2: function () {
            var c = this;
            this.$btn = b([this.$bannerBtn.get(0), this.$smallBtn.get(0)]), this.$btn.attr({
                href: c.conf.url,
                "data-downloadurl": c.conf.downloadUrl,
                "data-downloadmd5": c.conf.md5,
                "data-promotionid": c.conf.promotionId,
                "data-url": c.conf.openUrl
            }), a.app.bindTryOpenAppBanner && a.app.bindTryOpenAppBanner({$btn: c.$btn, rewriteText: a.$.noop})
        }, setDownload3: function () {
            var a = this;
            this.$box = this.$panel, this.$btn = this.$smallBtn, this.$btn.attr({
                href: a.conf.url,
                "data-downloadurl": a.conf.downloadUrl,
                "data-downloadmd5": a.conf.md5,
                "data-promotionid": a.conf.promotionId,
                "data-url": a.conf.openUrl
            }), this.bindDownloader(this.$box, this.$btn), h.onStatusChange.call(this)
        }
    };
    c.prototype = {
        init: function (b) {
            if (b && 1 != b.config.type && b.config.isHtml5UseUI && !b.config.isShortVideo) {
                ...
                var c = this;
                if (this.player = b, this.$video = b.$video, this.vid = b.curVideo.getVid(), this.enable = this.hasLimit(), this.type = this.getLimitCase(), this.conf = d["case" + this.type], a.app && a.app.config && (this.conf.appName = this.conf.appName || a.app.config.defaultName), this.isqqlive) try {
                    b.config.disableLimitBanner = "1,2,3"
                } catch (e) {
                }
                return this.updateUserConfig(), this.isUseCase1UI(), this.showBanner = !this.hasAppBanner(), this.whenToDisableCase3(), a.app && a.app.isSupportApp ? void (0 !== this.type && (this.isqqlive && (this.showBanner = !1, this.showDownload = !1), this.enable && b.trigger && b.trigger("tvp.durationlimit.enable"), this.$video && this.$video.trigger && this.$video.on("tvp:player:videochange", function () {
                    c.enable = !1
                }), this.start())) : void (this.enable && this.macLimit())
            }
        }, hide: function () {
            var a = this;
            a.$smallBtnBox && a.$smallBtnBox.addClass(f.HIDE), a.$limitPlay && a.$limitPlay.addClass(f.HIDE), a.$limitRePlay && a.$limitRePlay.addClass(f.HIDE), a.$limitRePlay && a.$limitRePlay.addClass(f.HIDE), a.$panel && a.$panel.addClass(f.HIDE)
        }, updateUserConfig: function () {
            var a = this.player.config.disableLimitBanner, c = this.type + "", f = this.player.config.caseSetting,
                g = this.player.config.limitSetting;
            if (this.showDownload = !0, a && (a = a.split(","), a && a.length && b.inArray(c, a) > -1 && (this.showDownload = !1)), this.showDownload && 3 === this.type && (this.showDownload = this.randomShowSmallBtn()), f) for (var h in f) for (var i in f[h]) "object" === b.type(f[h][i]) ? b.extend(d[h][i], f[h][i]) : d[h][i] = f[h][i];
            g && b.extend(e, g), b.extend(this.conf, e)
        }, isUseCase1UI: function () {
            2 === this.type && this.showDownload === !1 && this.player.config.useLimitCase1UI === !0 && (this.type = 1, this.conf = d["case" + this.type], this.conf.appName = this.conf.appName || a.app.config.defaultName)
        }, hasLimit: function () {
            var a = this.player.curVideo.data, b = this, c = function (a) {
                b.player.curVideo.setDuration(a.toString()), b.preview = a, b.remain = a, b.duration = a
            };
            return this.player && this.player.config && this.player.config.isInewsLayer && a.preview > 60 ? (a.preview > 600 ? c(300) : a.preview > 60 && c(60), !0) : a && a.exem && a.preview ? (c(a.preview), !0) : !1
        }, getLimitCase: function () {
            var a = navigator.userAgent.toLowerCase(), c = e.case_regx, d = !1;
            return b(c).each(function (b, c) {
                return c.test(a) ? (d = !0, !1) : void 0
            }), this.enable ? d ? 1 : 2 : d ? 3 : 0
        }, start: function () {
            var a = this;
            this.getOnlineTipsText();
            try {
                a.showReport(), a.tipsSetting(), a.render(), a.initDOM(), a.initDisplay()
            } catch (c) {
            }
            var d = g["initEvent" + a.type];
            "function" === b.type(d) && d.call(a), a.showDownload && a.initDownload(), (1 === a.type || 2 === a.type) && g.playBtnEvent.call(a), this.$video.off("playing.limit-control").on("playing.limit-control", function () {
                a.duration = a.player.getDuration()
            }), this.$video.off("timeupdate.limit-control").on("timeupdate.limit-control", function () {
                var c = this.currentTime;
                c > a.duration && (this.pause(), this.ended = !0, b(this).trigger("ended"), a.$video && a.$video.trigger && a.$video.trigger("tvp:player:ended"))
            })
        }, tipsSetting: function () {
            var a = "\u770b\u7cbe\u5f69\u5b8c\u6574\u7248", b = d["case" + this.type].texts, c = "case" + this.type;
            a = this.bannerTips ? this.bannerTips : a;
            for (var e in b) d[c].texts[e] = (d[c].texts[e] + "").replace("${limitTips}", ", " + a)
        }, render: function () {
            var c = a.html5skin[e.name + "_case" + this.type], f = d["case" + this.type], g = f.texts,
                h = this.preview - 29;
            g && (h = 0 > h ? 1 : Math.ceil(h / 60), g.limitTime = h, c = b.formatTpl(c, g), this.renderData = g, this.$mod = this.player.$UILayer || this.player.$videomod, this.$mod.addClass("tvp_container"), this.element = b(c).appendTo(this.$mod))
        }, initDOM: function () {
            this.$mod && (1 === this.type ? (this.$panel = this.$mod.find('[data-role="tvp-limit-case1"]'), this.$limitRePlay = this.$mod.find('[data-role="tvp-limit-replay"]'), this.$limitPlay = this.$mod.find('[data-role="tvp-limit-play"]'), this.$banner = this.$mod.find('[data-role="tvp-limit-download"]'), this.$bannerBtn = this.$banner.find('[data-role="tvp-limit-download-btn"]'), this.$bannerTXT = this.$banner.find('[data-role="tvp-limit-download-text"]'), this.$smallBtnBox = this.$mod.find('[data-role="tvp-limit-timing"]'), this.$smallBtn = this.$smallBtnBox.find('[data-role="tvp-limit-timing-btn"]'), this.$smallBtnTXT = this.$smallBtnBox.find('[data-role="tvp-limit-timing-text"]'), this.$remain = this.$smallBtn.find('[data-role="tvp-limit-timing-text"]')) : 2 === this.type ? (this.$panel = this.$mod.find('[data-role="tvp-limit-case2"]'), this.$limitPlay = this.$mod.find('[data-role="tvp-limit-play"]'), this.$limitRePlay = this.$mod.find('[data-role="tvp-limit-replay"]'), this.$banner = this.$mod.find('[data-role="tvp-limit-download"]'), this.$bannerBtn = this.$banner.find('[data-role="tvp-limit-download-btn"]'), this.$smallBtnBox = this.$mod.find('[data-role="tvp-limit-timing"]'), this.$smallBtn = this.$smallBtnBox.find('[data-role="tvp-limit-timing-btn"]'), this.$replayText = this.$limitRePlay.find('[data-role="tvp-limit-replay-text"]'), this.$remain = this.$smallBtn.find('[data-role="tvp-limit-timing-text"]')) : 3 === this.type && (this.$panel = this.$mod.find('[data-role="tvp-limit-case3"]'), this.$smallBtn = this.$panel.find('[data-role="tvp-limit-timing-btn"]'), this.$smallBtnTXT = this.$panel.find('[data-role="tvp-limit-timing-text"]')), this.$play = this.$mod.find(a.html5skin.elements.overlay.play))
        }, initDisplay: function () {
            1 === this.type ? (this.showDownload && this.showBanner && this.$banner.removeClass(f.HIDE), this.$panel.removeClass(f.HIDE), this.$limitPlay.removeClass(f.HIDE), this.$play.addClass(f.HIDE)) : 2 === this.type ? (this.$panel.removeClass(f.HIDE), this.showDownload && this.showBanner && this.$banner.removeClass(f.HIDE), this.$play.addClass(f.HIDE)) : 3 === this.type && this.$panel.addClass(f.HIDE)
            ...
            var c = b.Deferred(), d = a.common.recomdTextById(this.vid), e = this;
            return 1 !== this.type ? (c.resolve(), c) : (d && "string" === b(d.rmdword) && d.rmdword ? (e.bannerTips = d.rmdword, e.reportData = d, c.resolve()) : d && "function" === b.type(d.done) ? d.done(function () {
                ...
                b && b.rmdword && (e.bannerTips = b.rmdword), e.reportData = b, c.resolve()
            }) : c.resolve(), c)
            ...
            if (this.remain && !this.downloaded) {
                ...
                c = 10 > c ? "0" + c : c, b = 10 > b ? "0" + b : b, a = b + ":" + c, this.$remain.attr("data-text", "\u8fd8\u5269 " + a)
            }
        }, delayHideDOM: function (a, b) {
            a = a || this.$panel, b = b || 1e4;
            var c = this;
            this.delayTimer || (this.delayTimer = setTimeout(function () {
                c.downloaded || a.addClass(f.HIDE), c.delayTimer = null
            }, b))
        }, showReport: function () {
            ...
            var c = b.Deferred(), d = this, e = this.conf.appName;
            return this.conf.promotionId ? this.conf.md5 ? (c.resolve(), c) : (a.app.getAppMd5(this.conf.promotionId, e).done(function (a) {
                a && a.md5 && (d.conf.md5 = a.md5), c.resolve()
            }).fail(function () {
                c.reject()
            }), c) : (c.reject(), c)
        }, check: function () {
            ...
            return this.conf.promotionId && d.conf.downloadUrl ? (this.getMD5().done(function () {
                return d.conf.md5 ? void a.app.check({
                    ...
                    a && a.openUrl && (d.conf.hasApp = a.hasApp, d.conf.openUrl = a.openUrl, d.conf.url = a.url), c.resolve()
                }) : void c.reject()
            }).fail(function () {
                c.reject()
            }), c) : (c.reject(), c)
            ...
            this.check().done(function () {
                if (a.conf && a.conf.openUrl && a.conf.url) {
                    ...
                    "undefined" !== b.type(c) && (c.call(a), h.clickReport.call(a), a.conf.hasApp && a.$box && "function" === b.type(a.$box.trigger) && a.$box.trigger("tvp:appdownload:hasapp"))
                }
            })
        }, bindDownloader: function (c, d) {
            var e = this,
                f = "string" === b.type(this.player.config.downloaderCallback) ? this.player.config.downloaderCallback : !1;
            this.player.config && this.player.config.plugins && this.player.config.plugins.AppBanner && this.player.config.plugins.AppBanner.downloaderCallback && (f = this.player.config.plugins.AppBanner.downloaderCallback), this.player.config && this.player.config.plugins && this.player.config.plugins.AppFollow && this.player.config.plugins.AppFollow.downloaderCallback && (f = this.player.config.plugins.AppFollow.downloaderCallback);
            var g = {
            ...
            var d = this, e = this.player, f = {vid: e.curVideo.getVid(), appCase: c, reportStep: b};
            f.promotionId = d.conf.promotionId, a.dataset.gPromotionId && (f.promotionId = a.dataset.gPromotionId), e.config.reportFrom && e.config.reportFrom.page && (f.xinwenTpl = e.config.reportFrom.page + ""), a.bossReport.appLunchShowClickReport(f)
            ...
            if (c) {
                var d, e, f, g, h = this.player.$UILayer, i = this.player.$video, j = i.parent().find("video"),
                    k = this;
                if (e = h.find('[data-role="tvp_fn_tips_box"]')) {
                    f = e.find('[data-role="tvp_fn_tips_text"]'), g = window.txv && txv.login && "function" === b.type(txv.login.openLogin), d = "v.qq.com" === window.location.hostname ? g ? '<span style="cursor: pointer;" class="tvp_link tvp_fn_openLogin">\u767b\u5f55</span>\u540e\u53ef\u89c2\u770b\u5b8c\u6574\u7248' : '<a class="tvp_link" href="http://v.qq.com/">\u767b\u5f55</a>\u540e\u53ef\u89c2\u770b\u5b8c\u6574\u7248' : '\u5728<a class="tvp_link" href="http://v.qq.com/">v.qq.com</a>\u767b\u5f55\u540e\u53ef\u89c2\u770b\u5b8c\u6574\u7248';
                    var l = function () {
                        f.html(d), "v.qq.com" === window.location.hostname && a.$(".tvp_fn_openLogin").off("click").on("click", function () {
                            window.txv && txv.login && txv.login.openLogin && (k.player && k.player.checkIsFullScreen && k.player.checkIsFullScreen() && k.player.cancelFullScreen(), txv.login.openLogin())
                        }), setTimeout(function () {
            ...
            this.$video.off("play.limit").off("playing.limit").off("pause.limit").off("timeupdate.limit").off("ended.limit"), 1 === this.type ? this.$panel.remove() : 2 === this.type ? (this.$panel.remove(), this.$smallBtnBox.remove()) : 3 === this.type && this.$panel.remove(), this.$video.trigger("tvp_durationlimit_hide")
        }
    }, a.html5DurationLimit = {
        create: function (b) {
            b.DurationLimitInstance && "function" === a.$.type(b.DurationLimitInstance.clear) && b.DurationLimitInstance.clear(), b.DurationLimitInstance = new c;
            try {
    ...
    function d(d, e) {
        ...
        var f = b.isFunction(e.getPlayerType) ? e.getPlayerType().toUpperCase() : "",
            g = "http://rcgi.video.qq.com/report/play?", h = this.getplatform(), i = ["TenPlayer", f, "V2.0"].join(""),
            j = {
                version: i,
                vid: this.vid,
                rid: this.rid,
        ...
        this.getStepName = function (a) {
            ...
            if (c) {
                ...
                try {
                    i.vt = e.curVideo.data.vl.vi[0].ul.ui[0].vt, i.tpay = e.curVideo.tpay, i.tpid = e.curVideo.getTpid && e.curVideo.getTpid(), i.tpid = e.curVideo.data.vl.vi[0].videotype || ""
                } catch (m) {
                    i.vt = 0
                }
                i.vurl = e.curVideo.url, i.bt = parseInt(e.getDuration(), 10), b.extend(k, i), k.step = c, k.ctime = b.getISOTimeFormat(), k.val = d, e && e.config && e.config.isShortVideo ? k.isshortvd = 1 : k.isshortvd = 0, k.opensource = {
                    mqqcartoon: 1,
                    "ugch5.m.v.qq.com": 2,
                    "buluo.qq.com": 3
                }[a.$.getUrlParam("openS") || e.config.openS], k.opensource || (k.opensource = 0), e.config.openS && /^\d+$/.test(e.config.openS + "") && (k.opensource = e.config.openS), e.curVideo && e.curVideo.getGuid && (k.cmid = e.curVideo.getGuid()), k.ua = a.common.getReportUA && a.common.getReportUA(), k.hh_ref = a.common.getTopFrameUrl && a.common.getTopFrameUrl(), k.hh_ref = k.hh_ref, k.url = k.url;
                for (var n in k) {
                    var o = k[n];
                    isNaN(o) && (o = encodeURIComponent("" + o)), h.push(n + "=" + o)
                }
                l += h.join("&"), a.bossReport.play_report(h)
            }
    ...
    b.extend(a.Html5Tiny.fn, {
        buildmonitor: function () {
            ...
            this.$video.on("playing", function () {
                setTimeout(function () {
                    c.isPlayingLoadingAd() && (c.hasAds = !0, d && d.reportStep(7, {val1: 1}))
                }, 90)
            }), this.$video.on("tvp:video:ajaxstart", function (b, e, g) {
                f = g, d = null, d = new a.H5Monitor(e, c), d.addStep(f ? 1009 : 1011), d.addStep(7)
            }).on("tvp:video:ajaxsuc", function () {
                d && (d.report(3, 1), d.reportStep(f ? 1009 : 1011, {val1: 1, val2: 0}))
            }).on("tvp:video:src", function () {
                e = 0, d.report(4, 1, {val2: 1}), d.addStep(6), d.addStep(30), c.$video.one("canplay", function () {
                    d && d.reportStep(30, {val1: 0, val2: 2})
                }).one("error", function () {
                    d && (d.reportStep(30, {val1: 1, val2: 2}), d.report(5, 0, {val1: 3}))
                }).one("playing", function () {
                    d && (d.reportStep(6, {val1: c.hasAds ? 4 : 1}), d.addStep(5), h({itype: 1}), c.$video.one("tvp:player:ended", function () {
                ...
                d && 1 != ++e && (c.isDefinitionSwitching || c.isTouching || (d.addStep(31), c.$video.one("timeupdate", g)))
            }).one("tvp:h5ui:playbtn:click", function () {
                h({itype: 4})
            });
            var g = function () {
    ...
    function c(c, d) {
        this.isUseControl = !1, this.config = b.extend({}, this.config), this.config.width = a.$.filterXSS(c), this.config.height = a.$.filterXSS(d), this.control = null, this.$UILayer = null;
        var e = this;
    ...
    a.extend(tvp.html5skin, {
        html: function () {
        ...
        }(), noSVGClassName: "tvp_no_svg", elements: {
            title: {main: ".tvp_titles", text: ".tvp_title span"},
            meta: {main: ".tvp_meta_info", duration: ".tvp_meta_duration", filesize: ".tvp_meta_length"},
            layer: ".tvp_container",
            ...
            timePanel: {cur: ".tvp_time_panel_current", total: ".tvp_time_panel_total"},
            bigben: {
            ...
            posterlayer: {main: ".tvp_overlay_poster", img: ".tvp_poster_img"},
            tips: {main: ".tvp_overlay_tips", desc: " .tvp_overlay_tips .tvp_text"},
            promotion: {main: ".tvp_promotion", link: ".tvp_promotion >a"},
            loadingAd: {
                main: ".tvp_ads",
    ...
    a.Html5UI = function (a) {
        ...
        getCurVideo: function () {
            ...
            b.each(this.feature, function (e, f) {
                if (!d.player.isForbiddenH5UIFeature(f)) if (f in d.player.config.html5FeatureExtJS) {
                ...
                d.isHidden() && (d.videoTag.currentTime || d.overlayPlayClicked) ? (d.show(), d.beginHide(3e3)) : d.hide(), a.preventDefault(), a.stopPropagation()
            ...
            var b = this;
            a = a || 3e3, this.stopHide(), this.hideControlTimer = setTimeout(function () {
                b.isTouching || b.hide()
            }, a)
        }, stopHide: function () {
            this.hideControlTimer && (clearTimeout(this.hideControlTimer), this.hideControlTimer = 0)
        }, hide: function () {
            this.$UILayer.addClass("tvp_controls_hide"), this.$control && this.$control.trigger && this.$control.trigger("tvp:control:hide"), this.$video && (this.$video.trigger("tvp:preview:hide"), this.$video.trigger("tvp:volume:hide"))
        }, show: function () {
            return 1 == this.$video.data("data-playing-loadingad") ? void this.hide() : (this.hideControlTimer && (clearTimeout(this.hideControlTimer), this.hideControlTimer = 0), this.$UILayer.removeClass("tvp_controls_hide"), void (this.$control && this.$control.trigger && this.$control.trigger("tvp:control:show")))
        }, isHidden: function () {
    ...
    a.Html5Bullet = function (a, b, c) {
        this.player = a, this.$video = b, this.$UILayer = c, this.$videomod = this.player.$videomod, this.init()
    }, a.Html5Bullet.prototype = {
        init: function () {
            var a = this.player.config.html5LiveUIFeature, c = this.player.config.h5LiveBullet, d = this;
            -1 !== a.indexOf("bullet") && c && this.player.config.isHtml5UseUI && (b(this.get_html()).appendTo(this.$videomod), this.setDomRole(), this.bulletId = this.player.curVideo.getH5BulletId(), this.bulletId && (this.check_bullet_db_switch().done(function () {
                d.init_events(), d.init_style(), d.set_top_values(), d.init_switch_status()
            }).fail(function () {
        ...
        start: function () {
            var a = this;
            this.reset_animate_speed(), this.show();
            var b = setTimeout(function () {
                c.hasInsertNullTips = !1, clearTimeout(b), b = null
            }, 5e3);
            a.text_list[0] === c.null_tips || c.hasInsertNullTips || (a.text_list.unshift(c.null_tips), c.hasInsertNullTips = !0), a.add_bullet(), this.text_list.length > 20 || a.request_live_cgi(), this.cgi_timer && clearInterval(this.cgi_timer), this.cgi_timer = setInterval(function () {
                a.request_live_cgi()
            }, 1e3 * this.cgi_interval), this.bullet_timer && clearInterval(this.bullet_timer), this.bullet_timer = setInterval(function () {
                a.add_bullet()
            }, 1e3 * c.bullet_interval)
        },
        stop: function () {
            clearInterval(this.cgi_timer), clearInterval(this.bullet_timer), this.hide(), this.$bullet.empty()
        },
        reset_animate_speed: function () {
            var a = this;
            setTimeout(function () {
                c.speed[0] = parseInt(a.$bullet.parent().width() / c.one_second_per_px), c.speed[1] = c.speed[0] + 3
            }, 500)
        },
        show: function () {
        ...
        update_switch_db_status: function (a) {
            a = "undefined" == typeof a ? 0 : 1, b.setData(this.switch_db_key, a)
        },
        init_events: function () {
            var d = this, e = "click";
            this.$switch.off(e).on(e, function () {
                var b = d.check_switch(), c = b ? 0 : 1;
                b ? (d.set_switch_close(), d.stop(), d.update_switch_db_status()) : (d.set_switch_open(), d.check_video() && d.start(), d.update_switch_db_status(1)), a.bossReport.report_bullet_switch({
                    user_action: c,
            ...
            var f = function () {
                setTimeout(function () {
                    d.reset_top_values()
                }, 200), d.reset_animate_speed()
            };
            b(window).off("orientationchange", f).on("orientationchange", f), this.player.$mod.off("tvp:bullet:enterfullscreen").on("tvp:bullet:enterfullscreen", f), this.player.$mod.off("tvp:bullet:cancelfullscreen").on("tvp:bullet:cancelfullscreen", f);
            var g = function () {
                d.check_switch() && d.start()
            }, h = function () {
                c.hasInsertNullTips = !1, d.stop()
            }, i = function () {
                d.stop()
            };
        ...
        init_style: function () {
            this.$videomod.css({position: "relative"})
        },
        ...
        add_bullet: function () {
            var a = this;
            a.insert_bullet(a.text_list.shift()), a.insert_bullet(a.text_list.shift()), a.insert_bullet(a.text_list.shift())
        },
        sendMyBullet: function (b) {
            return (b = a.$.filterXSS(b)) ? (b = ['<span style="color:#fec800;">', b, "</span>"].join(""), this.text_list.unshift(b), !0) : !1
        },
        check_bullet_db_switch: function (a) {
            var c = a || b.Deferred(), d = this;
        ...
        request_live_cgi: function () {
            if (!(this.text_list.length >= c.full_nums)) {
                ...
                var g = {session_key: f.session_key || "", last_stamp: f.cgi_timestamp, pid: f.bulletId};
                return a = b.cookie.get("rtx_uin"), a || (a = b.cookie.get("uin")), a || (a = b.cookie.get("luin")), a && (g.uin = a), b.ajax({
                    url: d,
                    cache: !1,
                    data: g,
                    dataType: "json",
                    ...
                    a && a.loop_interval && (f.cgi_interval = parseInt(a.loop_interval)), a && a.last_stamp && (f.cgi_timestamp = a.last_stamp), a && a.session_key && (f.session_key = a.session_key), a && a.comments && a.comments.length && b(a.comments).each(function (a, c) {
        ...
        setDomRole: function () {
            this.$bullet = this.$videomod.find('[data-role="tvp-mod-bullet"]'), this.$switch = this.$videomod.find('[data-role="tvp-bullet-switch"]')
        },
        reset_top_values: function () {
            this.topValues = {}, this.set_top_values()
        },
        set_top_values: function () {
            for (var a = c.margin || 20, d = this.$bullet.parent().height(), d = d ? d : this.player.config.height, d = "string" == typeof d && d.indexOf("%") > -1 ? b("#" + this.player.config.modId).height() : d, e = d - c.ctrl_height, f = 3, g = f; e > g; g++) this.topValues[g] = 0, g += a
        },
        get_one_top_value: function () {
            var a, b, c, d = [];
            for (var e in this.topValues) 0 === this.topValues[e] && d.push(e);
            return a = d.length, 0 === a ? !1 : this.filter_ctrl() ? !1 : (c = this.get_random(0, a - 1), b = d[c], this.topValues[b] = 1, b)
        },
        ...
        filter_ctrl: function () {
            var a = this.get_topValue_count(), b = a.b.length, d = a.a.length;
    ...
    b.extend(a.Html5UI.fn, {
        buildoverlay: function (c, d, e, f) {
            var g = d[0], h = {}, i = d.parent().find("video"), j = 2 === i.length ? !0 : !1, k = this, l = "tvp_none",
                m = !1, n = !1;
            ...
            var o = {
                ...
                j && "0" === b(this).attr("data-focus") || (o.hideLoading(), o.hidePlay(), o.hideReplay())
            }, q = function () {
                ...
                j && "0" === b(this).attr("data-focus") || c.isDefinitionSwitching || (o.showLoading(), o.hidePlay(), o.hideReplay())
            }, s = function () {
                j && "0" === b(this).attr("data-focus") || o.hideLoading()
            }, t = function () {
                j && "0" === b(this).attr("data-focus") || c.isDefinitionSwitching || (o.hideReplay(), o.hidePlay(), o.showLoading())
            }, u = function () {
                o.hideLoading(), o.hidePlay(), o.showReplay()
            }, v = function () {
                m = !0
            }, w = function () {
                m = !1
            ...
            }).on("playing", p).on("pause", q).on("seeking", r).on("seeked", s).on("tvp_adonend_ended", u), d.on("tvp:overlay:update:filesize", function (a, b) {
                b && h.filesize && (b = parseInt(b / 1024), b > 1024 ? b = parseInt(b / 102.4) / 10 + "M" : b += "K", h.filesize.html(b))
            ...
            var x = function () {
                ...
                g.src && (d.trigger && d.trigger("tvp:h5ui:playbtn:click"), n || (n = !0, k.overlayPlayClicked = !0, g.currentTime || g.load()), g.paused && (0 === g.buffered.length && g.load(), g.play(), h.filesize && h.filesize.addClass("tvp_none"), o.hidePlay(), o.showLoading()), a.dataset.openLazy = !1, a.$(document).trigger("tvp:report:continue").trigger("tvp:loadingad:continue"))
            };
            h.play.on("click", x);
            var y = function () {
                o.hideReplay(), o.hidePlay(), o.showLoading(), c.seekVideoIndex(1, 0)
            }, z = function () {
                if (c.isPlayingSplit) return void y();
                if (d.trigger("tvp:player:videoreplay"), c.config.isHtml5ShowLoadingAdOnStart && c.config.isHtml5ShowLoadingAdOnReplay) {
                    if (!c.curVideo || "function" !== b.type(c.curVideo.getRequestAd)) return;
                    if (c.curVideo.getRequestAd() === !1) ; else if (c.curVideo.getRequestAd() === !0) return
                }
                g.load(), g.play(), o.hideReplay(), o.hidePlay(), o.showLoading()
            };
    ...
    b.extend(a.Html5UI.fn, {
        buildplaypause: function (c, d, e, f) {
            var g = f.find(a.html5skin.elements.play), h = d[0], i = d.parent().find("video"),
                j = 2 === i.length ? !0 : !1, k = this, l = !1;
            g.on(b.os.hasTouch && !b.os.Mac ? "touchend" : "click", function () {
                if (j) {
                    var a = i.filter('[data-focus="1"]');
                    a && a.length && (h = a[0])
                }
                h.paused ? (l || (l = !0, h.currentTime || h.load()), h.play()) : h.pause()
    ...
    b.extend(a.Html5UI.fn, {
        buildprogress: function (c, d, e) {
            function f() {
                ...
                e.find(".tvp_time_rail").on(n.start, function (b) {
                    if (b = b.originalEvent ? b.originalEvent : b, !m || b && b.touches && b.touches.length) {
                        var d;
                        d = m ? b.touches[0] : b, g.isRotate ? (a = d.pageY, j = i.cur.height()) : (a = d.pageX, j = i.cur.width()), c.isDefinitionSwitching = !1, g.isTouching = !0, g.player.isTouching = !0, h.pause(), k = 0, b.preventDefault()
                    }
                }).on(n.move, function (b) {
                    if (g.isTouching && (b = b.originalEvent ? b.originalEvent : b, !m || b && b.touches && b.touches.length)) {
                        var h, n, o;
                        h = m ? b.touches[0] : b, d = g.isRotate ? h.pageY : h.pageX, f = d - a, k = j + f, l = g.isRotate ? i.total.height() : i.total.width(), k = k > l ? l : 0 > k ? 0 : k, n = k / l, o = c.getDuration() * n, o = isNaN(o) ? 0 : o, g.setProgress(k, i), e.trigger && e.trigger("tvp:progress:touchstart", {
                            pos: k,
                            precent: n,
                            time: o
                        }), b.preventDefault()
                    ...
                    if (h.play(), g.isTouching) {
                        l = g.isRotate ? i.total.height() : i.total.width(), !k && b.changedTouches && b.changedTouches.length && (k = j + (b.changedTouches[0].pageX - a));
                        var d = k / l, f = c.getDuration() * d;
                        c.seek(f), e.trigger && e.trigger("tvp:progress:touchend"), g.isTouching = !1, g.player.isTouching = !1, b.preventDefault(), b.stopPropagation()
                    }
                })
            }
            ...
            this.isTouching = !1, b.each(a.html5skin.elements.progress, function (a, b) {
            ...
            }), f(), d.bind("timeupdate", function (a) {
                if (a = a.originalEvent ? a.originalEvent : a, !g.isHidden() && !c.isDefinitionSwitching && 4 == a.target.readyState) {
                    var b;
                    b = g.isRotate ? h.currentTime / c.getDuration() * i.total.height() : h.currentTime / c.getDuration() * i.total.width(), g.setProgress(b, i)
                }
            }), d.bind("progress", function () {
                if (!c.isDefinitionSwitching) {
                    var a = 0;
                    h.buffered && h.buffered.length > 0 && h.buffered.end && c.getDuration() && (a = h.buffered.end(0) / c.getDuration(), a = parseInt(100 * a) + "%", i.loaded.css("width", a))
                }
                ...
                resetProgress: function () {
                    i.cur.css("width", "0px"), i.loaded.css("width", "0px")
                }
            })
        }, setProgress: function (a, b) {
            var c, d = b.handle.width(), e = a - d / 2;
            c = b.total.height(), c = this.isRotate ? b.total.height() : b.total.width(), e = Math.min(e, c - d), e = Math.max(e, 0), b.cur.css("width", a + "px")
        }
    })
}(tvp, tvp.$), function (a, b) {
    var c = null, d = "", e = "", f = {calcTimer: null, times: 0, changeTimes: 0};
    b.extend(a.Html5Player || {}, {isFullScreen: !1}), b.extend(a.Html5UI.fn, {
        buildfullscreen: function (d, e, f, g) {
            ...
            a.Html5Player && a.Html5Player.fn && b.extend(a.Html5Player.fn, i), a.Html5Live && a.Html5Live.fn && b.extend(a.Html5Live.fn, i), e.on && e.on("ended", function () {
                setTimeout(function () {
            ...
            if (!this.player.videoTag || 0 != this.player.videoTag.currentTime || !b.os.ipad) {
                ...
                (top === window || c || b.os.ios || !this.player.config.isHtml5UseFakeFullScreen) && (this.player.config.isHtml5UseFakeFullScreen ? this.allEnterFullScreen() : this.enterRealFullScreen(), this.player.isFullScreen = !0, this.player.callCBEvent("onfullscreen", !0), a.bossReport.user_action_report({
                    actions: "fullscreen",
                    vid: this.player.curVideo.getVid()
                }))
            }
        }, cancelFullScreen: function () {
            this.player.config.isHtml5UseFakeFullScreen ? this.allCancelFullScreen() : this.cancelRealFullScreen(), this.player.isFullScreen = !1, this.player.callCBEvent("onfullscreen", !1), a.bossReport.user_action_report({
                actions: "exitfullscreen",
                vid: this.player.curVideo.getVid()
            })
        }, enterRealFullScreen: function () {
            var a = this, c = a.$video, d = c[0];
            d.webkitSupportsFullscreen ? d.webkitEnterFullscreen() : d.webkitRequestFullScreen && d.webkitRequestFullScreen(), (b.browser.WeChat || b.browser.MQQClient) && b.os.android || this.fixClassName(1)
        }, cancelRealFullScreen: function () {
            var a = this, b = a.$video, c = b[0];
            this.fixClassName(0), c.webkitExitFullscreen && c.webkitExitFullscreen()
            ...
            if (a && c) try {
                frameElement && (frameElement.style.cssText = d), this.cancelFakeFullScreen()
            } catch (e) {
                this.player.config.isHtml5UseFakeFullScreen = !1, this.cancelRealFullScreen()
            } else this.cancelRealFullScreen()
        }, allEnterFullScreen: function () {
            var a = this.player.config.isHtml5UseFakeFullScreen,
                c = b.os.android || b.os.ios && this.player.config.isiPhoneShowPlaysinline, e = top.innerWidth;
            if (a && c) try {
                frameElement && (d = frameElement.style.cssText, b(frameElement).css({
                ...
                this.player.config.isHtml5UseFakeFullScreen = !1, this.enterRealFullScreen()
            } else this.enterRealFullScreen()
        }, enterFakeFullScreen: function () {
            if (!this.checkIsFullScreen()) {
                this.fixClassName(1), this.$mod.trigger("tvp:bullet:enterfullscreen");
                var a = top.innerWidth, d = top.innerHeight, f = (Math.ceil((d - a) / 2), this);
                e = this.player.$videomod[0].style.cssText, this.player.$videomod.find("video").off("ended.recommendshow").on("ended.recommendshow", function () {
                    ...
                    left: 0
                }), this.listenOrientationChange(), c.removeClass("tvp_fullscreen"), c.addClass("tvp_unfullscreen"), this.$UILayer.addClass("tvp_fullscreen_mode")
            }
        }, cancelFakeFullScreen: function () {
            this.fixClassName(0), this.$mod.trigger("tvp:bullet:cancelfullscreen"), e && (this.player.$videomod[0].style.cssText = e), c.removeClass("tvp_unfullscreen"), c.addClass("tvp_fullscreen"), this.$UILayer.removeClass("tvp_fullscreen_mode"), this.isRotate = !1, this.unbindOritationChange()
        }, listenOrientationChange: function () {
            var a = this.player, c = this, d = function () {
                var d = top.innerWidth, e = top.innerHeight;
                f.s0 && f.s1 && (90 === Math.abs(top.orientation) ? (d = f.s1.width, e = f.s1.height) : (d = f.s0.width, e = f.s0.height)), window !== top && frameElement && b(frameElement).css({
                    position: "fixed !important",
                    ...
                    top: 0,
                    left: 0
                }), c.isRotate = !1, c.$mod && c.$mod.trigger && c.$mod.trigger("tvp:recommend:orientationchange"), c.$video && c.$video.trigger && setTimeout(function () {
                    c.$video.trigger("timeupdate"), c.$video.trigger("progress")
                }, 100)
            };
            try {
                c.setCalcValue(), b(top).off("orientationchange.fullscreen").on("orientationchange.fullscreen", function () {
            ...
            var c = this;
            a = a || function () {
            }, f.times >= 2 || (f.times += 1, f.calcTimer = setInterval(function () {
                c.setCalcValue(), f.changeTimes >= 1 && (clearInterval(f.calcTimer), f.calcTimer = null, setTimeout(function () {
                    c.setCalcValue(), a()
                }, 100))
            }, 50), b.os.iphone && setTimeout(function () {
                c.setCalcValue(), a()
            }, 100), setTimeout(function () {
                f.calcTimer && clearInterval(f.calcTimer), c.setCalcValue(), a()
            }, 2e3))
        }, setCalcValue: function () {
            var a = {width: top.innerWidth, height: top.innerHeight};
            90 === Math.abs(top.orientation) ? (f.s1 && f.s1.width !== a.width && f.changeTimes++, f.s1 = a) : (f.s0 && f.s0.width !== a.width && f.changeTimes++, f.s0 = a)
        }, unbindOritationChange: function () {
            try {
                b(top).off("orientationchange"), b(top.document.body).off("touchmove"), b(document.body).off("touchmove")
            } catch (a) {
            }
        }
    })
    ...
    b.extend(a.Html5UI.fn, {
        buildposterlayer: function (c, d, e, f) {
            var g = f.find(a.html5skin.elements.posterlayer.main), h = g.find(a.html5skin.elements.posterlayer.img),
                i = this, j = function (a) {
                    if (a = a || c.curVideo.getPoster() || c.config.pic, 0 == a.length) {
                        var e = h.attr("data-pic");
                        "" != e && (a = e)
                    }
                    b.isString(a) && a.length > 0 ? (a = b.filterXSS(a), h.attr("data-pic", a).css("background-image", "url(" + a + ")"), (!b.os.ios || b.os.ios && b.compareVersion(b.os.version, "8.0") > -1) && d.attr("poster", "//i.gtimg.cn/qqlive/images/20150608/black.png"), k()) : l(), a && (d.trigger("tvp:video:setposter"), h.off("load.tvp_video_showposter").one("load.tvp_video_showposter", function () {
                    ...
                    c && c.control && c.control.checkIsFullScreen && !c.control.checkIsFullScreen() && g.show(), d.one("play playing", l)
                }, l = function () {
                    g.hide()
                };
            c.config.isHtml5ShowPosterOnStart && j(), b.extend(this, {
                ...
                showPoster: k,
                hidePoster: l
            }), b.extend(c, {setPoster: j}), (b.os.iphone || b.os.ipod) && c.config.isiPhoneShowPosterOnPause && d.on("pause paused", function () {
    ...
    b.extend(a.Html5UI.fn, {
        buildshadow: function (a, c, d, e) {
            var f = b('<div class="tvp_shadow"></div>').appendTo(e.find(".tvp_video")), g = this;
            a.config.isHtml5ControlAlwaysShow || f.on("click", function (c) {
                ...
                if (g.isHidden() && (g.videoTag.currentTime || g.overlayPlayClicked)) {
                    var e = b(g.videoTag);
                    "1" != e.attr("data-playing-adonend") && (g.show(), g.beginHide(3e3))
                } else g.hide();
    ...
    function c(c, d, e, f) {
        var g = new a.Html5LoaingAd, h = f.find(a.html5skin.elements.loadingAd.main),
            e = h.find(a.html5skin.elements.loadingAd.control), i = h.find(a.html5skin.elements.loadingAd.countdown),
            j = h.find(a.html5skin.elements.loadingAd.skip), k = h.find(a.html5skin.elements.loadingAd.more),
            l = h.find(a.html5skin.elements.loadingAd.adLink);
        d.on("tvp:player:videochange", function () {
            c.config.isHtml5ShowLoadingAdOnChange && (d.attr("data-playing-loadingad", "1"), g.getAdData())
            ...
            a = a || {}, "undefined" === b.type(a.noOrder) && (a.noOrder = !0), h.addClass("tvp_none"), d.attr("data-playing-loadingad", "0");
            var e, f = function () {
                var b = "1" === d.attr("tvp_loadingad_ended");
                b ? (clearTimeout(e), d.trigger && d.trigger("tvp:loadingad:ended", {
            ...
            setTimeout(function () {
                clearTimeout(e)
            }, 6e3), f(), c.callCBEvent("onh5loadingadend"), d.on("tvp:player:videochange", function () {
                clearTimeout(e)
            })
        }, g.onStart = function () {
            d.attr("data-playing-loadingad", "1"), h.removeClass("tvp_none"), c.callCBEvent("onh5loadingadstart")
        }, g.create(c, {
            $container: h,
            $control: e,
        ...
        buildloadingAd: function (d, e, f, g) {
            function h() {
                if (!d.loadingadInited && d.config.isHtml5ShowLoadingAdOnStart) {
                    if (d.loadingadInited = !0, "function" != typeof a.Html5LoaingAd) {
                        var h = FILEPATH + "plugins/loadingad.js?max_age=86400";
                        return h += "&t=" + a.ts, void b.getScript(h, function () {
            ...
            b.browser.WeChat ? (a.common.afterWeChatReady({timeout: 5e3}).done(function () {
                h()
    ...
    function c(a, c, e, f) {
        this.player = a, this.$video = c, this.$control = e, this.$UILayer = f, this.config = {}, b.extend(this.config, d), a.config.verticalBulletID ? this.vid = a.config.verticalBulletID : a.config.isShortVideo && a.config.longVideoID ? this.vid = a.config.longVideoID : this.vid = a.curVideo.getVid(), this.isShortVideo = a.config.isShortVideo, this.init()
    }

    var d = {max: 1, index: 0, speed: 1e3, maxCount: 50};
    c.prototype = {
        init: function () {
            this.initRole(), this.initEvents()
        },
        initRole: function () {
        ...
        initEvents: function () {
            ...
            this.$video.on("playing.v_bullet", function () {
                a.hasInit ? a.isPlayingAd() || (a.needReInit && (a.initHTML(), a.needReInit = !1), a.show(), a.startMove()) : a.initData()
            }), this.$video.on("pause.v_bullet", function () {
                a.isPlayingAd() || (a.hide(), a.stopMove())
            }), this.$video.on("ended.v_bullet", function () {
                a.index = 0, a.needReInit = !0
            })
        },
        initData: function () {
            var a = this;
            this.hasInit || (this.hasInit = !0, this.requestData().done(function () {
                a.initHTML(), a.isPlayingAd() || (a.show(), a.startMove())
            }).fail(function () {
        ...
        initHTML: function () {
            if (this.data && this.data.length) {
                var a = this.blankData.concat(this.data.slice(0, this.config.max)), b = this.renderHTML(a);
                this.index = this.config.max - 1, this.$bullet.html(b)
            }
        },
        startMove: function () {
            var a = this;
            this.stopMove(), !this.data || this.data.length < 1 || (this.timer = setInterval(function () {
                a.addNext()
            }, this.config.speed))
        },
        stopMove: function () {
        ...
        addNext: function () {
            var a = this;
            !this.data || this.data.length < 1 || (this.$bullet.find(".tvp_out").remove(), setTimeout(function () {
                a.$bullet.find(".tvp_barrage_item:nth-child(1)").addClass("tvp_out"), a.$bullet.find(".tvp_barrage_item:nth-child(2)").addClass("tvp_fadeout"), a.index++;
        ...
        requestData: function () {
            ...
            return e({
                ...
                dataType: "html",
                data: {otype: "json", num: c.isShortVideo ? 20 : 50},
                cache: !1,
                timeout: 8e3
            }).done(function (b) {
                try {
                    b = b && 0 === b.indexOf("QZOutputJson=") ? b.replace(/^QZOutputJson=/, "").replace(/\;$/, "") : b.replace(/^[\w_]+\(/, "").replace(/\)$/, ""), b = JSON.parse(b)
                } catch (d) {
                    b = ""
                }
                return "string" == typeof b ? void a.reject() : void (b && b.hotcomments && b.hotcomments.length ? (c.data = b.hotcomments.slice(0, c.config.maxCount), a.resolve()) : a.reject())
            }).fail(function () {
                a.reject()
            }), a
        }
