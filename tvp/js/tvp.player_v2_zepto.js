...
*/
!function (a) {
    if (tvp = {}, tvp.lastModify = "2018-10-23 11:05:05",
        tvp.ts = tvp.lastModify.replace(/\D/g, ""),
        tvp.ver = "$V2.0Build9502$",
        tvp.dataset = {openLazy: !0},
        tvp.name = "\u817e\u8baf\u89c6\u9891\u7edf\u4e00\u64ad\u653e\u5668",
        "undefined" == typeof window.DEBUG && (window.DEBUG = 1),
        window.FILEPATH = "//imgcache.qq.com/tencentvideo_v1/tvp/js/",
        "http:" === location.protocol ? window.FILEPATH = "http:" + window.FILEPATH : window.FILEPATH = "https:" + window.FILEPATH, top != window) try {
    ...
    tvp.log = function (a) {
        ...
        news: 10001,
        qqmusic: 10007
    }, tvp.ACTION = {onVodH5Init: "tvp:vodhtml5:beforeInit", onFlashPlayerInited: "tvp:flash:inited"}, function (a) {
        function b(b, c, d) {
            var e = a.Event(c);
    ...
    "undefined" != typeof Zepto && Zepto._tvp ? (tvp.$ = Zepto, c = !0) : (tvp.$ = {}, c = !1), function () {
        ...
        return "film.qq.com" == document.location.host && (h = !0), {
            getOcx: function (b) {
                ...
                if ("0.0.0" != e) return e;
                var a, b = null, c = null, d = [], i = "Shockwave Flash", j = navigator,
                ...
                if (tvp.$.browser.ie) try {
                    ...
                    c = j.plugins[i].description, a = "plugins[S].description", c && (tvp.$.isUndefined(j.mimeTypes) || !j.mimeTypes[k] || j.mimeTypes[k].enabledPlugin) ? (a = "parse description", c = c.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), d[0] = parseInt(c.replace(/^(.*)\..*$/, "$1"), 10), d[1] = parseInt(c.replace(/^.*\.(.*)\s.*$/, "$1"), 10), d[2] = /[a-zA-Z]/.test(c) ? parseInt(c.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0) : a = "no mimeTypes or disable");
    ...
    d.ha = function (a) {
        ...
        return c
    }, d._urlStr = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", d.urlenc = function (a, b, c) {
        for (var e, f, g, h, i, j, k, l = "", m = 0; m < a.length;) e = a.charCodeAt(m++), f = a.charCodeAt(m++), g = a.charCodeAt(m++), 15 == m && (l += "A", l += b, l += c), h = e >> 2, i = (3 & e) << 4 | f >> 4, j = (15 & f) << 2 | g >> 6, k = 63 & g, isNaN(f) ? j = k = 64 : isNaN(g) && (k = 64), l = l + d._urlStr.charAt(h) + d._urlStr.charAt(i) + d._urlStr.charAt(j) + d._urlStr.charAt(k);
        return l
    }, d.$xx = function (a, b, c, e, f) {
        f = f || parseInt(+new Date / 1e3);
        var e = ("" + e).charAt(0), g = "", h = "",
            i = {plt: a || "", vid: b || "", std: c || "", sts: e || "", ts: f, rf: g, ua: h};
        ...
        var j = d.hexToString(d.ha(a + b + f + d._Seed + g + h + e.charAt(0) + c)),
            ...
            l = d.urlenc(d.tempcalc(j, "86FG@hdf"), e.charAt(0), f), m = d.u1(k, 0), n = d.u1(k, 1);
                    ...
                    "function" === a.$.type(window.getBrowserSignature) ? window.getBrowserSignature(c.cfg.vid, function (a) {
                        if (a && -1 !== a) {
                            var d = {
                                ...
                                param: {cKey: a, encryptVer: "6.4", platform: "170101", vid: c.cfg.vid, defn: c.cfg.fmt}
                            };
                            b.resolve(d)
                        }
                    }) : b.reject()
        ...
        function j(e, f) {
            ...
            if ("object" == typeof d && "function" == typeof d.$xx && "string" == typeof e) {
                g = b.getUrlParam("platform", e), h = b.getUrlParam("vids", e), h || (h = b.getUrlParam("vid", e)), i = c(), e.indexOf("mvgetinfo?") > -1 && (b.os.iphone ? i = "V3013" : b.os.ipad ? i = "V4013" : b.os.android && (i = "V5013"));
                try {
                    l = d.$xx(g, h, i, k, f)
                } catch (m) {
                    "function" == typeof a.reportErr && m && m.message && a.reportErr(m.message)
                }
                l && (j = j + "&_qv_rmt=" + l.u1, j = j + "&_qv_rmt2=" + l.u2, b.getUrlParam("sdtfrom", e) || (j = j + "&sdtfrom=" + i), e = e + (-1 == e.indexOf("?") ? "?" : "&") + j, b.cookie.set("qv_als", l.c))
            }
            return e
        }
        ...
        k.cgi = function () {
            ...
            loadVideoUrlByVid: function (c) {
                ...
                }, b.browser.WeChat && (b.os.ipad ? u.device = "60101" : b.os.iphone ? u.device = "60401" : b.os.android && !b.os.tablet ? u.device = "60301" : b.os.android && b.os.tablet && (u.device = "60501")), n.commonAuthData && (n.commonAuthData.auth_from || n.commonAuthData.auth_ext) && (n.commonAuthData.auth_from && (u.auth_from = n.commonAuthData.auth_from), n.commonAuthData.auth_ext && (u.auth_ext = n.commonAuthData.auth_ext)), d.retryDefer && b.isFunction(d.retryDefer.reject) && (w = !0, q = d.retryDefer, x = k.retryCgi.getinfo, C = k.retryCgi.getkey), d.loadingAdCgi && (x = d.loadingAdCgi, d.noAuth = !0), d.defer && (q = d.defer), B = i({
                    itype: 1,
                    val2: w ? 1 : 0,
                    str3: A,
                    vid: n.vid,
                ...
                var D = function (e) {
                    ...
                    var h, k = l.ul.ui[0];
                    o.br = l.br, o.path = k.url, o.fn = l.fn, o.fiid = e(n, f.fl.fi), o.vt = k.vt, h = new a.RetCode(100127), h.begin(), y = b.now();
                    ...
                    n.commonAuthData && (n.commonAuthData.auth_from || n.commonAuthData.auth_ext) && (n.commonAuthData.auth_from && (u.auth_from = n.commonAuthData.auth_from), n.commonAuthData.auth_ext && (u.auth_ext = n.commonAuthData.auth_ext)), A = C + b.param(v), A = j(A, m), B = i({
                        ...
                        h.reportErr(), B({
                            val: 500,
                            speed: b.now() - y
                        }), w ? q.reject(500, 2) : (d.retryDefer = q, a.h5Helper.loadVideoUrlByVid(d))
                    })
                }, F = function () {
                    ...
                    u._rnd = c, A = x + b.param(u), f && "object" === b.type(f) && (A += "&" + b.param(f)), A = j(A, c), b.ajax({
                        ...
                        if (!d.noAuth && c && 0 != c.em && "o" != c.s) {
                            if (85 === c.em && -3 === c.type && 1 === d.cgi_auth_index) return d.cgi_auth_index += 1, d.defer = q, d.needTime = !0, d.svr_time = c.curTime, void a.h5Helper.loadVideoUrlByVid(d);
                            if (83 === c.em && u.eduext) ; else if (!(b.inArray(c.em, [100]) > -1)) return d.noAuth = !0, d.defer = q, void a.h5Helper.loadVideoUrlByVid(d)
                        }
                        D(c)
                    }).fail(function () {
                        if (v.reportErr(), B({val: 500, speed: b.now() - y}), w) q.reject(500, 1); else {
                            ...
                            setTimeout(function () {
                                d.noAuth = !0, d.retryDefer = q, a.h5Helper.loadVideoUrlByVid(d)
                            }, c)
                        }
                    })
                };
        ...
        a.livehub = {
            g_flashp2p: !1, iretcode: 0, g_curCnlInfo: {}, stepReport: function (c, d) {
                ...
                "object" == b.type(d) && (e = b.extend(e, {
                    ...
                    int5: d.code,
                    vid: d.lid
                }), d.config && (e = b.extend(e, {contentId: d.config.contentId, appId: d.config.appid}))), a.report(e)
        ...
        function d(c, d, e) {
            var f = b.now(), h = f - g, i = {cmd: 3529, val: c, str4: d, speed: 0 > h ? b.now() - f : h};
        ...
        function e(c, d) {
            ...
            var f = b.Deferred();
            a[e] = f;
            var g = window.FILEPATH, i = c.toLowerCase();
            ...
            if ("function" == typeof a[c]) f.resolve(); else {
                var k = new a.RetCode(100123), l = b.now();
                k.begin(), d(1), b.getScript(j, function () {
                    var e = b.now() - l;
                    if ("function" != typeof a[c]) throw k.reportErr(11), d(2, 11, e), new Error(h[1]);
                    d(2, 0, e), k.reportSuc(), f.resolve()
                })
            }
            return f
        }
        ...
        var g = b.now(),
            ...
            i = function (c, d) {
                ...
                return c.video.setCurPlayer(d), i.checkLivePlayer = j, b.when(c.type == a.PLAYER_DEFINE.VOD ? g() : j(c.video)).then(function () {
        ...
        a.Player = function (c, e) {
            this.sessionId = b.createGUID(), d(1, this.sessionId), this.instance = null, this.config = {}, this._oldcfg = {}, b.extend(this.config, a.defaultConfig), this.setting("width", c), this.setting("height", e)
            ...
            setting: function (a, b) {
                ...
                var f = this;
                f.config = b.extend({}, f.config, e), d(2, this.sessionId, {
                ...
                var g = function () {
                    i(f.config, f).done(function (c, g) {
                        ...
                        c.callCBEvent("onwrite"), f.config.type == a.PLAYER_DEFINE.LIVE && (f.play = function (c) {
                            "undefined" == typeof c && (c = f.getCurVideo()), b.isString(c) ? (f.config.video.setChannelId(c), c = f.config.video) : c instanceof a.VideoInfo && b.when(i.checkLivePlayer(c)).then(function () {
                                f.instance instanceof a[g] ? f.instance.play(c) : (e.video = c, i(e))
                            })
        ...
        a.extend(a.fn, {
            createTVP: function (b) {
                if (tvp.report({cmd: 3546, val: 4}), b = a.extend({}, tvp.defaultConfig, b || {}), b.video) {
                    var c = null;
